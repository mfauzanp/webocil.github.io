...
<head>
  ...
  <!-- start: Css -->
  <link rel="stylesheet" type="text/css" href="asset_minimum/css/bootstrap.min.css">

  <!-- plugins -->
  <link rel="stylesheet" type="text/css" href="asset_minimum/css/plugins/font-awesome.min.css" />
  <link rel="stylesheet" type="text/css" href="asset_minimum/css/plugins/simple-line-icons.css" />
  <link rel="stylesheet" type="text/css" href="asset_minimum/css/plugins/animate.min.css" />
  <link rel="stylesheet" type="text/css" href="asset_minimum/css/plugins/fullcalendar.min.css" />
  <link href="asset_minimum/css/style.css" rel="stylesheet">
  <!-- end: Css -->
...
<body id="mimin" class="dashboard">
      ...
      <div class="navbar-header" style="width:100%;">
        ...
        <ul class="nav navbar-nav navbar-right user-nav">
          ...
          <li class="dropdown avatar-dropdown">
            <img src="asset_minimum/img/avatar.jpg" class="img-circle avatar" alt="user name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" />
            <ul class="dropdown-menu user-dropdown">
              <li><a href="#"><span class="fa fa-user"></span> My Profile</a></li>
              <li><a href="<?= base_url('beranda') ?>"><span class="fa fa-book"></span> My Library</a></li>
              <li role="separator" class="divider"></li>
              <li class="more">
                <ul>
                  <li><a href=""><span class="fa fa-cogs"></span></a></li>
                  <li><a href=""><span class="fa fa-lock"></span></a></li>
                  <li><a href="<?= base_url('auth/logout') ?>"><span class="fa fa-power-off "></span></a></li>
                </ul>
              </li>
            </ul>
          </li>
    ...
    <div id="left-menu">
      <div class="sub-left-menu scroll">
        <ul class="nav nav-list">
          ...
          <li class="ripple"><a href="<?php echo base_url('Buku/tampildatabuku'); ?>"><span class="fa-home fa"></span>Dashboard</a></li>
          <li class="ripple"><a class="tree-toggle nav-header"><span class="fa-book fa"></span> Anggota <span class="fa-angle-right fa right-arrow text-right"></span> </a>
            <ul class="nav nav-list tree">
              <li><a href="<?php echo base_url('Buku'); ?>">Tambah Anggota</a></li>
              <li><a href="<?php echo base_url('Buk u/tampildatabuku'); ?>">Tampil Data Anggota</a></li>
            </ul>
          </li>
          <li class="ripple"><a class="tree-toggle nav-header"><span class="fa-book fa"></span> Buku <span class="fa-angle-right fa right-arrow text-right"></span> </a>
            <ul class="nav nav-list tree">
              <li><a href="<?php echo base_url('Buku'); ?>">Input Buku</a></li>
              <li><a href="<?php echo base_url('Buku/tampildatabuku'); ?>">Tampil Buku</a></li>
              <li><a href="<?php echo base_url('Buku/databuku'); ?>">Data Buku</a></li>
            </ul>
          </li>
          <li class="ripple"><a href="<?php echo base_url(''); ?>"><span class="fa fa-info-circle"></span>About</a></li>
          <li class="ripple"><a href="<?php echo base_url(''); ?>"><span class="fa fa-fw fa-calendar-o"></span>Calendar</a></li>
      ...
      <div class="panel">
        <div class="panel-body">
          <div class="col-md-6 col-sm-12">
            ...
            <p class="animated fadeInDown"><span class="fa  fa-map-marker"></span> South Sumatra,Indonesia</p>

          </div>
          <div class="col-md-6 col-sm-12">
            <div class="col-md-6 col-sm-6 text-right" style="padding-left:10px;">
              <h3 style="color:#DDDDDE;"><span class="fa  fa-map-marker"></span> Palembang</h3>
            ...
            <div class="col-md-12 padding-0">
              <div class="panel box-v2">
                <div class="panel-heading padding-0">
                  <img src="asset_minimum/img/bg2.jpg" class="box-v2-cover img-responsive" />
                  <div class="box-v2-detail">
                    <img src="asset_minimum/img/avatar.jpg" class="img-responsive" />
                    <h4>Ocil</h4>
                  </div>
                </div>
                <div class="panel-body">
      ...
      <div class="tab-content">
        <div id="right-menu-user" class="tab-pane fade in active">
          ...
          <div class="user col-md-12">
            <ul class="nav nav-list">
              <li class="online">
                <img src="asset_minimum/img/avatar.jpg" alt="user name">
                <div class="name">
                ...
                <div class="msg_container_base">
                  <div class="row msg_container send">
                    ...
                    <div class="col-md-3 col-xs-3 avatar">
                      <img src="asset_minimum/img/avatar.jpg" class=" img-responsive " alt="user name">
                    </div>
                  </div>
              ...
              <ul>
                <li class="online">
                  <a href="" data-toggle="tooltip" data-placement="left" title="Akihiko avaron">
                    <div class="user-avatar"><img src="asset_minimum/img/avatar.jpg" alt="user name"></div>
                    <div class="dot"></div>
                  </a>
                </li>
                <li class="offline">
  ...
  <!-- start: Javascript -->
  <script src="asset_minimum/js/jquery.min.js"></script>
  <script src="asset_minimum/js/jquery.ui.min.js"></script>
  <script src="asset_minimum/js/bootstrap.min.js"></script>


  <!-- plugins -->
  <script src="asset_minimum/js/plugins/moment.min.js"></script>
  <script src="asset_minimum/js/plugins/fullcalendar.min.js"></script>
  <script src="asset_minimum/js/plugins/jquery.nicescroll.js"></script>
  <script src="asset_minimum/js/plugins/jquery.vmap.min.js"></script>
  <script src="asset_minimum/js/plugins/maps/jquery.vmap.world.js"></script>
  <script src="asset_minimum/js/plugins/jquery.vmap.sampledata.js"></script>
  <script src="asset_minimum/js/plugins/chart.min.js"></script>


  <!-- custom -->
  <script src="asset_minimum/js/main.js"></script>
